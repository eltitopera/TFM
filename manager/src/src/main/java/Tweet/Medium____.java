...
public class Medium____ implements Serializable
{
    ...
    private final static long serialVersionUID = -3316849179752139524L;
     ...
     * @param expandedUrl
     */
    public Medium____(String sourceUserIdStr, Long sourceUserId, String sourceStatusIdStr, Long sourceStatusId, Sizes__ sizes, String type, String expandedUrl, String displayUrl, String url, String mediaUrlHttps, String mediaUrl, List<Long> indices, String idStr, Long id) {
        super();
