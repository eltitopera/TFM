...
import redis.common.container.RedisCommandsContainerBuilder;
import redis.common.mapper.RedisCommand;
import redis.common.mapper.RedisDataType;
import redis.common.mapper.RedisCommandDescription;
import redis.common.mapper.RedisMapper;
    ...
    public void invoke(IN input) throws Exception {
        ...
        switch (redisCommand) {
            ...
            case ZREM:
                ...
                break;
            case HSET:
                this.redisCommandsContainer.hset(redisSinkMapper.getListKeyFromData(input), key, value);
                break;
            default:
